...
public class LibraryDatabase implements IterableCollection{
	...
	public ArrayList<DigitalItem> digItemsDB;
	public ArrayList<PhysicalItem> physItemsDB;
	public ArrayList<Course> coursesDB;
	...
	public PhysicalItem physicalItemGenerator(String itemType, String name, String author, String edition, String publisherName, 
    ...
    public ArrayList<Item> getRecommendations(String searchQuery) {
